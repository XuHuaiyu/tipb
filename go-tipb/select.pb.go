...
type DAGRequest struct {
	...
	VeloxPlan        []byte `protobuf:"bytes,19,opt,name=velox_plan,json=veloxPlan" json:"velox_plan,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *DAGRequest) GetVeloxPlan() []byte {
	if m != nil {
		return m.VeloxPlan
	}
	return nil
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VeloxPlan != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintSelect(dAtA, i, uint64(len(m.VeloxPlan)))
		i += copy(dAtA[i:], m.VeloxPlan)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *DAGRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VeloxPlan", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VeloxPlan = append(m.VeloxPlan[:0], dAtA[iNdEx:postIndex]...)
			if m.VeloxPlan == nil {
				m.VeloxPlan = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorSelect = []byte{
	...
	,
}
